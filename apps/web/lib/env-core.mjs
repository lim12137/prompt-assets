...
const DEFAULT_HOME_AI_TOOLS_BY_SLUG = new Map(
  DEFAULT_HOME_AI_TOOLS.map((tool) => [tool.slug, tool]),
);
...
function requireField(value, fieldName, fallback) {
...
function parseOrder(value, fieldName, fallback) {
...
function parseHomeAiTools(input) {
...
export function parseAppEnv(input = process.env) {
